...
const translations = {
  ...
  hi: {
    ...
    // Dialog boxes (alerts)
    confirmWallpaper:
      'क्या आप आज के लिए एक यादृच्छिक छवि को वॉलपेपर के रूप में सेट करना चाहेंगे?',
    confirmRestore:
      'क्या आप वाकई अपनी सेटिंग्स रीसेट करना चाहते हैं? यह क्रिया पूर्ववत नहीं की जा सकती।',
    ...
    onlylinks:
      'केवल लिंक (http:// या https:// से शुरू होने वाले) ही अनुमत हैं।',
    imagedimensions:
  ...
  bn: {
    ...
    editShortcutsListInfo:
      'আপনি "+" আইকনে ক্লিক করে নতুন শর্টকাট যোগ করতে পারেন অথবা শর্টকাটের নাম বা URL-এ ক্লিক করে বিদ্যমান শর্টকাট সম্পাদনা করতে পারেন।',
    ...
    // Dialog boxes (alerts)
    confirmWallpaper:
      'আপনি কি আজকের জন্য একটি নতুন চিত্র ওয়ালপেপার হিসেবে সেট করতে চান?',
    confirmRestore:
      'আপনি কি সত্যিই আপনার সেটিংস রিসেট করতে চান? এটি পূর্বাবস্থায় ফিরিয়ে নেওয়া যাবে না।',
...
function applyLanguage(lang) {
  ...
  if (themingElement) {
    const localizedText =
      translations[lang]?.reloadHint || translations['en'].reloadHint;

...
const translations = {
  "en": {
    ...
    "imagedimensions":
      "Warning: The uploaded image dimensions ({width}x{height}) exceed 1920x1080 pixels. \n\nThis may impact performance or image may fail to load properly.",
  ...
  "cs": {
    ...
    "hideSearchWithInfo":
      "Mezi vyhledávači přepnete klepnutím na jejich ikonky",
  ...
  "it": {
    ...
    // Dialog boxes (alerts)
    "confirmWallpaper":
      "Vuoi impostare una nuova immagine come sfondo per oggi?",
    "confirmRestore":
    ...
    "clearbackgroundimage":
      "Sei sicuro di voler rimuovere l'immagine di sfondo?",
    "confirmbackup":
      "Sei sicuro di voler eseguire il backup delle tue impostazioni?",
    "ProxyDisclaimer":
    ...
    "onlylinks":
      "Solo link (che iniziano con http:// o https://) sono consentiti.",
    "imagedimensions":
      "Attenzione: Le dimensioni dell'immagine caricata ({width}x{height}) superano i 1920x1080 pixel. \n\nCiò potrebbe influire sulle prestazioni o l'immagine potrebbe non essere caricata correttamente.",
  ...
  "uz": {
    ...
    "userLoc":
      "O'zingizning shahringiz yoki koordinatalaringiz (Kenglik, Uzunlik)",
  ...
  "es": {
    ...
    "googleAppsMenuInfo":
      "Mostrar accesos directos a las aplicaciones de Google",
    // Digital Clock
  ...
  "idn": {
    ...
    "editShortcutsListInfo":
      'Anda dapat menambahkan pintasan baru dengan mengeklik ikon "+" atau mengedit pintasan yang sudah ada dengan mengeklik nama pintasan atau URL',
    ...
    "fahrenheitCelsiusText":
      "Muat ulang halaman untuk mengaplikasikan perubahan",
  ...
  "mr": {
    ...
    "imagedimensions":
      "तयार केलेली इमेज ({width}x{height}) चे परिमाण 1920x1080 पिक्सल्सपेक्षा जास्त आहे. \n\nयामुळे कार्यक्षमता प्रभावित होऊ शकते किंवा इमेज नीट लोड होऊ नये.",
  ...
  "fr": {
    ...
    "googleAppsMenuText": "Apps Google",
    "googleAppsMenuInfo":
      "Afficher les raccourcis pour les Applications Google",
    // Digital Clock
    ...
    "onlylinks":
      "Seuls les liens (commençant par http:// ou https://) sont autorisés.",
    "imagedimensions":
      "Attention: Les dimensions de l'image téléchargée ({largeur}x{hauteur}) dépassent 1920x1080 pixels.\n\nCela peut avoir un impact sur les performances ou l'image peut ne pas se charger correctement.",
...
function applyLanguage(lang) {
  ...
  if (menuCloseButton) {
    const hoverText = translations[lang]?.menuCloseText ||
      translations["en"].menuCloseText;
  ...
  if (themingElement) {
    const localizedText = translations[lang]?.reloadHint ||
      translations["en"].reloadHint;

...
const translations = {
    "en": {
        ...
        "Winbookmarks": "Press Ctrl + Shift + B to show the bookmarks bar.",
        "Macbookmarks": "Press Cmd + Shift + B to show the bookmarks bar.",
        "endlink": "There shouldn't be / at the end of the link",
        "onlylinks": "Only links (starting with http:// or https://) are allowed.",
        "imagedimensions": "Warning: The uploaded image dimensions exceed 1920x1080 pixels. \n\nThis may impact performance or image may fail to load properly.",
    ...
    "ru": {
        ...
        "Winbookmarks": "Нажмите Ctrl + Shift + B чтобы показать панель закладок.",
        "Macbookmarks": "Нажмите Cmd + Shift + B чтобы показать панель закладок.",
        "endlink": "В конце ссылки не должно быть /",
        "onlylinks": "Разрешены только ссылки (начинаются с http:// or https://).",
        "imagedimensions": "Предупреждение: Размеры загруженного изображения превышают 1920x1080 пикселей. \n\nЭто может повлиять на производительность или изображение может не загрузиться должным образом.",
